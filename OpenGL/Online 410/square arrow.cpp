...
double squarelength = 30;
double arrow_angle = 45;
double f_angle = 0;
//double f_x = 2 * cos(arrow_angle*pi/180);
//double f_y = 2 * sin(arrow_angle*pi/180);
double f_x = 0;
double f_y = 0;
...
void drawSS()
{
    //;
    glPushMatrix();
    glTranslatef(f_x, f_y, 0);
    glRotatef(f_angle, 0, 0, 1);
    glRotatef(arrow_angle, 0, 0, 1);
    glBegin(GL_LINES);{
		glVertex3f( 0, 0, 0);
		//glVertex3f( -0 + 3*cos((arrow_angle)*pi/180), -0 + 3*sin((arrow_angle)*pi/180),0);
		glVertex3f(5, 0, 0);
	}glEnd();
//	glPopMatrix();
//	glPushMatrix();
...
//		glVertex3f( -0 + 3*cos((arrow_angle)*pi/180), -0 + 3*sin((arrow_angle)*pi/180),0);
//		glVertex3f( -0 + 3*cos((arrow_angle)*pi/180)-2*cos((arrow_angle)*pi/180), -0 + 3*sin((arrow_angle)*pi/180),0);
//		glVertex3f( -0 + 3*cos((arrow_angle)*pi/180), -0 + 3*sin((arrow_angle)*pi/180)-2*sin((arrow_angle)*pi/180),0);
		glVertex3f( 5, 0, 0);
		glVertex3f( 4, -1 ,0);
		glVertex3f( 4, 1, 0);
	}glEnd();
...
void animate(){
	...
	f_x+=(rot_dir*.03*cos(arrow_angle*pi/180));
	f_y+=(rot_dir*.03*sin(arrow_angle*pi/180));
	if(abs(f_x) > squarelength-.01 || abs(f_y) > squarelength-.01)
    {
        f_angle = 180 - f_angle;
        rot_dir*=-1;
